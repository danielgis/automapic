...
def GetLibPath():
    ...
    import arcpy, os
    # keyESRI = _winreg.OpenKey(_winreg.HKEY_CURRENT_USER, "Software\ESRI\Desktop10.4")
    # print(dir(keyESRI))
    # return _winreg.QueryValueEx(keyESRI, "InstallDir")[0] + "com\\"
    return os.path.join(arcpy.GetInstallInfo()['InstallDir'], 'com\\')
...
def InitStandalone():
    ...
    if not pVM.LoadVersion(esriVersion.esriArcGISDesktop, "10.4"):
        return False
    # Get license
